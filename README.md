Bu proje, DemSoftware yazılım firmasının web sitesini oluşturan basit bir 6 sayfalı web sitesidir. HTML5, CSS3 ve JavaScript özellikleri kullanılarak geliştirilmiş ve görsel açıdan zenginleştirilmiştir.
